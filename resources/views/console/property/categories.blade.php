        ...
        <div class="col-sm-12">
            <div class="card-box">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form class="form-horizontal heiz-dashboard-forms form-fix-width" role="form" action="{{route('property.categories')}}" id="addTable" method="post" enctype="multipart/form-data" data-parsley-validate="" novalidate="" autocomplete="off">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" disabled="disabled" :value="tty" parsley-trigger="change" maxlength="50">
                                        <input type="hidden" name="type_prefix" class="form-control" :value="tty" parsley-trigger="change" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="">Code</label>
                                        <input type="text" name="code" v-model="category.code" class="form-control" value="" placeholder="Category Code" parsley-trigger="change" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="">Description</label>
                                        <input type="text" name="description" v-model="category.description" class="form-control" value="" placeholder="Code Description" parsley-trigger="change" maxlength="50">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="tty" @blur="prefixType()" name="type_id" id="">
                                        <option v-if="update_btn" selected="true" disabled>@{{property_type_name}}</option>
    ...
    var app = new Vue({
      ...
      methods: {
        fetchCategoriesData(id){
            ...
            axios.get(`/api/v1/console/get_property_category/${id}`)
        ...
        checkResponse(response){
            ...
            axios.get(`/api/v1/console/get_property_type_name_2/${this.category.type_id}`)
            .then(response => {console.log(response.data.data), this.property_type_name = response.data.data})
        },
        updateData(){
            var data = this.category;
            // var url = `/api/v1/console/update_property_owner/${ownerData.id}`;
            console.log(data)
            axios.put(`/api/re_update_property_category/${data.code}`, data)
        ...
        deleteData(){
            ...
            // var url = `/api/v1/console/update_property_owner/${ownerData.id}`;
            console.log(data)
            axios.delete(`/api/re_delete_property_category/${data.id}`)
