        ...
        <div class="col-sm-12">
            <div class="card-box">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form class="form-horizontal heiz-dashboard-forms form-fix-width" role="form" action="{{route('property.types')}}" id="addTable" method="post" enctype="multipart/form-data" data-parsley-validate="" novalidate="" autocomplete="off">
                            @csrf
    ...
    var app = new Vue({
      ...
      methods: {
        fetchTypesData(id){
            ...
            axios.get(`/api/v1/console/get_property_type/${id}`)
        ...
        updateData(){
            ...
            console.log(data)
            axios.put(`/api/re_update_property_type/${data.id}`, data)
        ...
        deleteData(){
            ...
            // var url = `/api/v1/console/update_property_owner/${ownerData.id}`;
            console.log(data)
            axios.delete(`/api/re_delete_property_type/${data.id}`)
