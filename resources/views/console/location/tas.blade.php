        ...
        <div class="col-sm-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row table-fixed-height">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" aria-label="Table No: activate to sort column ascending" style="width: 229px;">Town Area Council</th>
                                ...
                                <tbody>
                                    <tr role="row" class="odd" v-for="data in tas">
                    ...
                    <div class="col-md-6">
                        <form class="form-horizontal heiz-dashboard-forms form-fix-width" role="form" action="{{route('location.tas')}}" id="addTable" method="post" enctype="multipart/form-data" data-parsley-validate="" novalidate="" autocomplete="off">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control" value="" placeholder="Tas Code" parsley-trigger="change" maxlength="50" required="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <!-- <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">Zonal Counsel</label>
                                        <select class="form-control" name="zonal_id" id="">
                                            <template v-for="zonal in zonals">
                                                <option :value="zonal.id">@{{zonal.description}}</option>
                                            </template>
                                        </select>
                                    </div>
                                </div>
