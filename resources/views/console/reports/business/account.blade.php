    ...
    <div class="container">
        ...
        <div class="card-box table-responsive">
            <div id="datatable-responsive_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  <form class="" action="{{route('report.business.account')}}" method="post">
                    @csrf
                    <div class="col-sm-10">
                          <h3 style="color: #a52a2a;">Business Report</h3>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-md-3 m-top-20">
                              <div class="form-group">
                                ...
                                <select style="width: 100%;" class="form-control" name="type">
                                  ...
                                  <?php
                                    $types = \App\BusinessType::latest()->get();
                            ...
                            <div class="col-md-3 m-top-20">
                              <div class="form-group">
                                ...
                                <select style="width: 100%;" class="form-control" name="category">
                                  <option value="">skip</option>
                                  <?php
                                    $categories = \App\BusinessCategory::latest()->get();
                            ...
                            <div class="col-md-3 m-top-20">
                              <div class="form-group">
                                ...
                                <select style="width: 100%;" class="form-control" name="owner">
                                  <option value="">skip</option>
                                  <?php
                                    $owners = \App\BusinessOwner::latest()->get();
                    ...
                    <div class="col-sm-10 m-top-20">
                      ...
                      <div class="row dragdrop">
                        <button type="button" class="form-control" @click.prevent="buttonDidTouch('business_no')" id="business_no">account no</button>
                        <button type="button" class="form-control" @click.prevent="buttonDidTouch('business_type')" id="business_type">business type</button>
                        <button type="button" class="form-control" @click.prevent="buttonDidTouch('business_category')" id="business_category">business category</button>
                        <button type="button" class="form-control" @click.prevent="buttonDidTouch('business_owner')" id="business_owner">business owner</button>
                        <button type="button" class="form-control" @click.prevent="buttonDidTouch('business_name')" id="business_name">business name</button>
                        ...
                        <button type="button" class="form-control" @click.prevent="buttonDidTouch('tin_number')" id="tin_number">tin number</button>
                      ...
                      <div class="row" style="display:none;">
                        <input type="text" id="business_no_in" value="">
                        <input type="text" id="business_type_in" value="">
                        <input type="text" id="business_category_in" value="">
                        <input type="text" id="business_owner_in" value="">
                        <input type="text" id="business_name_in" value="">
                        ...
                        <input type="text" id="tin_number_in" value="">
