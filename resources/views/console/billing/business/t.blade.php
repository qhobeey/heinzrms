            ...
            <div id="datatable-responsive_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                ...
                <div id="cardcont" style="display:block;">
                  <div id="card" style="width: 1000px; height: 100%; padding-top: 27px; padding-bottom: 20px; border-radius: 0px; background-color:white; margin-top: 40px; margin-bottom: 50px;">
                      <div style="width: 770px; background-color:white; margin-left:auto;">
                        <div style="background-color:white; width:725px; display: flex; flex-direction: row;">
                        ...
                        <div style="background-color: white; width:725px; display: flex;">
                          <div style="background-color: white; width: 380px;">
                            ...
                            <article style="width:100%; display:flex;">
                              <!-- <p style="color: black;margin-bottom: 0px;width: 28%;font-size: 13px; font-weight: 600;">Bus. Type:</p> -->
                              <p style="color: black;margin-bottom: 0px;font-size: 13px; font-weight: 300;"><span id="r_ac_type">COMMERCIAL Business RATE</span></p>
                            </article>
                            <article style="width:100%; display:flex;">
                              <!-- <p style="color: black;margin-bottom: 0px;width: 28%;font-size: 13px; font-weight: 600;">Bus. Cat:</p> -->
                        ...
                        <div style="background-color:white; width: 100%; font-size: 11px; color: black; margin-top:5px;">
                          ...
                          <h5 style="text-align: center; text-transform: uppercase; font-weight: 600; margin-top: -4px; color: black; font-size: 16px; letter-spacing: 2px;">pay your bills promptly and help the keep city clean</h5>
...
$(document).ready(function(){
  ...
  $('#repPrintBtn').on('click', function(){
    ...
    function replaceBill(mode) {
        ...
        document.getElementById('r_adjust_arrears').innerHTML = currentBill.arrears ? `${formatDollar(parseFloat(currentBill.arrears))} ` : `${formatDollar(0.0)} `
