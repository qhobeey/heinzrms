...
<div class="content">
  <div id="card">
    ...
    <div class="row" style="border-bottom: 2px solid black;">
      <h4 style="text-align: center; font-size: 14px; color: black; font-weight: 600;">Business Listing Grouped by <?= ucwords($electoral[0]->description); ?> <?= ucwords($location); ?> for <?= ucwords($year); ?></h4>
    </div>
