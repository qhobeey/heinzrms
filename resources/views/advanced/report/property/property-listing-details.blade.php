...
<div class="content">
  ...
  <div class="row" style="border-bottom: 2px solid black;">
    <h4 style="text-align: center; font-size: 14px; color: black; font-weight: 600;">Property Listing Grouped by <?= ucwords($electoral->description); ?> <?= ucwords($location); ?> Area for <?= ucwords($year); ?></h4>
  </div>
